...
dp <- dp00 %>% filter(administrative_level_3!="Unknown") %>% select(Savivaldybė = administrative_level_3, Apskritis = administrative_level_2, `Atvejai_100k` = confirmed_100k, `Atvejų augimas` = confirmed_growth_weekly,`Teigiamų tyrimų dalis` = tpr_tpn, `Tyrimų dalies pokytis` = tpr_tpn_diff_weekly, `Mirtys_100k` = deaths_100k, `Mirčių augimas` = deaths_growth_weekly, `Testai_100k` = tests_100k, Populiacija = population ) %>% arrange(-Populiacija) 
