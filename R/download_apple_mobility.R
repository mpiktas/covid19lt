...
dd <- data.frame(date = ymd("2022-01-21") + days(0:20), hotfix = 15 + 0:20)
# begin nolint
...
# https://covid19-static.cdn-apple.com/covid19-mobility-data/2118HotfixDev19/v3/en-us/applemobilitytrends-2021-10-08.csv
# https://covid19-static.cdn-apple.com/covid19-mobility-data/2204HotfixDev33/v3/en-us/applemobilitytrends-2022-01-03.csv
# https://covid19-static.cdn-apple.com/covid19-mobility-data/2206HotfixDev18/v3/en-us/applemobilitytrends-2022-01-24.csv
# end nolint
...
lap <- lapply(curdate - days(0:2), function(curd) {
  ...
  lnk <- glue::glue("https://covid19-static.cdn-apple.com/covid19-mobility-data/2206HotfixDev{hf}/v3/en-us/applemobilitytrends-{cd}.csv") # nolint
  print(lnk)
  try(read.csv(lnk))
})
