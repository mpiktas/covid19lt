...
aa_stats <- aa %>% select(
  ...
  deaths_100k,
  tests_100k,
  vaccinated_1_percent, vaccinated_2_percent, fully_protected_percent
)
...
vv1 <- vv %>%
  group_by(age, sex) %>%
  summarise(dose1 = sum(dose1), full = sum(full_protection))
...
## Ligoninių duomenys pagal ligonines `r ad_last_day` 
