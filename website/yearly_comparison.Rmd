...
dygraph(xs, main = "Nauji atvejai Lietuvoje 2020 ir 2021 metais, 7 dienų vidurkis") %>%
...
dygraph(xs, main = "Testų skaičius Lietuvoje 2020 ir 2021 metais, 7 dienų vidurkis") %>%
  dyOptions(colors = RColorBrewer::brewer.pal(3, "Set1")[1:2]) %>%
  dyRangeSelector(dateWindow = dw) %>%
  dyRoller(rollPeriod = 7)
```
